...
- Seal/guarantee: text in Spanish, shape, colors hex
...
OUTPUT FORMAT:
Return ONLY the final prompt — no preamble, no explanation, no headers. Ready to paste directly into Gemini with the product reference photos.`
}
